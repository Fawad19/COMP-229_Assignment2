...
I installed passport, flash, and passport-jwt for authentication. I also set up mongoDB connection as well as mongoose*/ 
...
app.use("/book-list", bookRouter);//add book-list
